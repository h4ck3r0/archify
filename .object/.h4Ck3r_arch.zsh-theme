...
# └─╼ ❯❯❯
PROMPT="
%F{\${ARCHIFY_PRIMARY}}┌─%F{\${ARCHIFY_PRIMARY}}[%F{\${ARCHIFY_SECONDARY}}󰣇 %B%F{\${ARCHIFY_SUCCESS}}\${SHELL_NAME:-H4CK3R}%b%F{\${ARCHIFY_WARN}}@%B%F{\${ARCHIFY_SECONDARY}}ARCH%b%F{\${ARCHIFY_PRIMARY}}]%F{\${ARCHIFY_PRIMARY}}-%F{\${ARCHIFY_PRIMARY}}[%B%F{\${ARCHIFY_SUCCESS}}%~%b%F{\${ARCHIFY_PRIMARY}}]%f \$(git_prompt_info)
