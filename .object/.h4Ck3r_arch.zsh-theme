...
# └─╼ ❯❯❯
PROMPT="
%F{red}┌─%F{red}[%F{\${ARCHIFY_SECONDARY}}󰣇 %B%F{\${ARCHIFY_PRIMARY}}\${SHELL_NAME:-H4CK3R}%b%F{yellow}@%B%F{\${ARCHIFY_SECONDARY}}ARCH%b%F{red}]%F{red}-%F{red}[%B%F{\${ARCHIFY_SUCCESS}}%~%b%F{red}]%f \$(git_prompt_info)
%F{red}└─╼ %B%F{\${ARCHIFY_PRIMARY}}❯%F{\${ARCHIFY_SECONDARY}}❯%F{\${ARCHIFY_SUCCESS}}❯ %f%b"
